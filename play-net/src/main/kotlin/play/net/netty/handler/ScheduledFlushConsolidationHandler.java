 ...
 * <p>
 * The {@link ScheduledFlushConsolidationHandler} should be put as first {@link ChannelHandler} in the
 * {@link ChannelPipeline} to have the best effect.
 */
public class ScheduledFlushConsolidationHandler extends ChannelDuplexHandler {
     ...
     */
    public ScheduledFlushConsolidationHandler() {
     ...
     */
    public ScheduledFlushConsolidationHandler(int explicitFlushAfterFlushes) {
     ...
     *                                        ongoing.
     */
    public ScheduledFlushConsolidationHandler(int explicitFlushAfterFlushes, boolean consolidateWhenNoReadInProgress) {
        this(explicitFlushAfterFlushes, consolidateWhenNoReadInProgress, 0);
    }
    ...
    private void scheduleFlush(final ChannelHandlerContext ctx) {
        if (nextScheduledFlush == null) {
            ...
            if (flushDelayMillis > 0) {
                nextScheduledFlush = ctx.channel().eventLoop().schedule(flushTask, flushDelayMillis, TimeUnit.MILLISECONDS);
            } else {
