package play.example.game.module.maintask

import javax.inject.Inject
import javax.inject.Singleton
import play.example.game.module.maintask.config.MainTaskConfig
import play.example.game.module.maintask.config.MainTaskConfigSet
import play.example.game.module.maintask.domain.MainTaskErrorCode
import play.example.game.module.maintask.domain.MainTaskLogSource
import play.example.game.module.maintask.entity.MainTaskEntityCache
import play.example.game.module.maintask.entity.PlayerMainTask
import play.example.game.module.player.Self
import play.example.game.module.task.AbstractTaskService
import play.example.game.module.task.domain.TaskErrorCode
import play.example.game.module.task.domain.TaskLogSource
