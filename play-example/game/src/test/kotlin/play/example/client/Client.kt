...
import play.example.game.base.net.codec.RequestEncoder
import play.example.game.base.net.codec.ResponseDecoder
...
object Client {
  ...
  fun main(args: Array<String>) {
    val client = NettyClient("test", "localhost", 8080, bootstrap())
    client.connect()
