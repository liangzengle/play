package play.codegen.kapt//package play.codegen
//
...
//        .map { it as DeclaredType }
//        .find {
//          it.asElement().toString() == GroupedWithUniqueKey.canonicalName
...
//          typeName == Grouped.canonicalName || typeName == GroupedWithUniqueKey.canonicalName
//        }?.let { it.typeArguments[0] } as? DeclaredType
//    }
//
