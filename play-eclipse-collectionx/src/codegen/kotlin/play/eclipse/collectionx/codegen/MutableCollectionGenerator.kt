 ...
 * @author LiangZengle
 */
class MutableCollectionGenerator {

  fun generate(elemType: KClass<*>, eclipseCollectionType: KClass<*>, eclipseMutableIteratorType: TypeName): TypeSpec {
    return TypeSpec.classBuilder("Mutable${elemType.simpleName}CollectionWrapper")
      .superclass(java.util.AbstractCollection::class.parameterizedBy(elemType))
      .addSuperinterface(MutableCollection::class.parameterizedBy(elemType))
      .primaryConstructor(
