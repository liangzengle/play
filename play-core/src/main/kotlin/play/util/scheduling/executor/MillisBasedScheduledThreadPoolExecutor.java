...
class MillisBasedScheduledThreadPoolExecutor
    ...
    public MillisBasedScheduledThreadPoolExecutor(int corePoolSize, long maxAwaitMills, ThreadFactory threadFactory) {
        super(corePoolSize, Integer.MAX_VALUE, 0, NANOSECONDS,
    ...
    private <V> RunnableScheduledFuture<V> decorateTask(
    ...
    static class DelayedWorkQueue extends AbstractQueue<Runnable>
        ...
        public DelayedWorkQueue(long maxAwaitMillis) {
                ...
                for (; ; ) {
                    ...
                    if (first == null)
                        ...
                        if (leader != null)
                            ...
                            leader = thisThread;
                            try {
                                available.await((Math.min(delay, maxAwaitMillis)), MILLISECONDS);
                            } finally {
